...
const CCButton = defineComponent({
  ...
  setup(props, { slots, emit }) {
    ...
    const btnTypeBaseClass: Record<string, string> = {
    ...
    const buttonTypeClass = computed(() => {
      return btnTypeBaseClass[props.type];
    });
    ...
    const buttonBeforeClass = computed(() => {
      return "before:duration-700 before:-z-10 before:absolute before:left-0 before:w-full before:h-0 before:bg-blue-500";
    });
